...
const AnnounceFoundItem = () => {
  ...
  const handleSubmit = (event) => {
    ...
    alert('Found item announcement submitted (mock).')
    ...
    <div className="lf-page">
      ...
      <form className="lf-form" onSubmit={handleSubmit}>
        <label className="lf-field">
          ...
          <input type="text" required placeholder="e.g. Navy blue jacket" />
        </label>

        <label className="lf-field">
          <span className="lf-field-label">Where did you find it?</span>
          <input type="text" required placeholder="e.g. Sports Complex - Locker Room" />
        </label>

        <label className="lf-field">
          <span className="lf-field-label">When did you find it?</span>
        ...
        <label className="lf-field">
          ...
          <textarea rows={4} placeholder="Add details that can help the owner recognize it." />
        </label>

        <label className="lf-field">
          <span className="lf-field-label">Where can it be collected?</span>
          <input type="text" required placeholder="e.g. Security desk" />
        </label>
