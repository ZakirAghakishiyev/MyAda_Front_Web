...
const FMSupport = () => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="fm-support-title"
    >
      <div className="it-support-popup">
        <header className="it-support-header">
          ...
          <div className="it-support-header-title">
            <h1 id="fm-support-title">New FM Request</h1>
          ...
          <section className="it-support-section">
            ...
            <div className="it-support-fields">
              ...
              <p className="it-support-hint">
                Include the nature of the issue, where it is located, and any steps you've already taken.
              </p>
            </div>
          </section>
